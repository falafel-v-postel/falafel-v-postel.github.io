...
//import css from '../game/index.css';
...
function create() {
    ...
    bg = game.add.tileSprite(0, 0, 1024, 3000, 'backgroundMain');
    ...
    rocketman.makeParticles('bombHit', [0], 5, true, true);
    ...
    rocketman2.makeParticles('bombKill', [0], 5, true, true);
    ...
    // Music intro
    music2 = game.add.audio('introMain');
    music2.play();   
    ...
    explosions.createMultiple(10, 'kaboomPlayer');
    explosions.setAll('anchor.x', 0.5);
    explosions.setAll('anchor.y', 0.5);
    explosions.forEach(player => player.animations.add('kaboomPlayer'));
    
    //  An explosion pool (rocketman vs. rocketman)
    explosions2 = game.add.group();
    explosions2.createMultiple(30, 'kaboomBomb');
    explosions2.setAll('anchor.x', 0.5);
    explosions2.setAll('anchor.y', 0.5);
    explosions2.forEach(rocketman => rocketman.animations.add('kaboomBomb'));    
}
...
function rocketman2HitsPlayer (player,rocketman2) {
    ...
    explosion.play('kaboomPlayer', 10, false, true);
...
function rocketman2HitsRocketman (rocketman,rocketman2) {
    ...
    explosion2.play('kaboomBomb', 30, false, true);

    // Sound effects
    sound3 = game.add.audio('boomSound', 0.3);
    sound3.play();
